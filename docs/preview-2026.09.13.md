# Experimental translation update: 2026.09.13-preview.71
...
1135 source-reviewed description records. This preview also reflows 96
source-reviewed equipment-description records; 4847 records still exceed the
...
```console
python patch.py check client-english-2026.09.13-preview.71.zip --target "C:\Games\MHF\dat"
python patch.py apply client-english-2026.09.13-preview.71.zip --target "C:\Games\MHF\dat"
```
