...
two Mezeporta archives. The latest description pass adds 30 reviewed entries to the cumulative 621-entry description pass;
514 entries remain in the current plain-text shortening queue. Other review
