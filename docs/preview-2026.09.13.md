...
two Mezeporta archives. The latest description pass adds 10 reviewed entries to the cumulative 1085-entry description pass;
50 entries remain in the current plain-text shortening queue. Other review
