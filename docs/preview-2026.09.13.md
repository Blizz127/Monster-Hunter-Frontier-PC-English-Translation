# Experimental translation update: 2026.09.13-preview.61
...
1135 source-reviewed description records. This preview also reflows 42 fresh
over-width equipment records; the current census still has 23706 over-width records requiring review;
...
```console
python patch.py check client-english-2026.09.13-preview.61.zip --target "C:\Games\MHF\dat"
python patch.py apply client-english-2026.09.13-preview.61.zip --target "C:\Games\MHF\dat"
```
