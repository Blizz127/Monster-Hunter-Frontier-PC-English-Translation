...
two Mezeporta archives. The latest description pass adds 32 reviewed entries to the cumulative 204-entry description pass;
931 entries remain in the current plain-text shortening queue. Other review
