...
two Mezeporta archives. The latest description pass adds 10 reviewed entries to the cumulative 985-entry description pass;
150 entries remain in the current plain-text shortening queue. Other review
