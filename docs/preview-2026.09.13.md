# Experimental translation update: 2026.09.13-preview.101
...
source-reviewed equipment-description records; 2919 records still exceed the
...
```console
python patch.py check client-english-2026.09.13-preview.101.zip --target "C:\Games\MHF\dat"
python patch.py apply client-english-2026.09.13-preview.101.zip --target "C:\Games\MHF\dat"
```
