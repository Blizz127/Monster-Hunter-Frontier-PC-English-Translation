# Experimental translation update: 2026.09.13-preview.68
...
1135 source-reviewed description records. This preview also reflows 43
source-reviewed equipment-description records; 5225 records still exceed the
...
```console
python patch.py check client-english-2026.09.13-preview.68.zip --target "C:\Games\MHF\dat"
python patch.py apply client-english-2026.09.13-preview.68.zip --target "C:\Games\MHF\dat"
```
