...
two Mezeporta archives. The latest description pass adds 10 reviewed entries to the cumulative 1055-entry description pass;
80 entries remain in the current plain-text shortening queue. Other review
