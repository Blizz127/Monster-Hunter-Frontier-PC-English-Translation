...
two Mezeporta archives. The latest description pass adds 30 reviewed entries to the cumulative 561-entry description pass;
574 entries remain in the current plain-text shortening queue. Other review
