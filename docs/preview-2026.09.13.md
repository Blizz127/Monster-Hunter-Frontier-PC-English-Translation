# Experimental translation update: 2026.09.13-preview.99
...
source-reviewed equipment-description records; 2981 records still exceed the
...
```console
python patch.py check client-english-2026.09.13-preview.99.zip --target "C:\Games\MHF\dat"
python patch.py apply client-english-2026.09.13-preview.99.zip --target "C:\Games\MHF\dat"
```
