...
two Mezeporta archives. The latest description pass adds 30 reviewed entries to the cumulative 294-entry description pass;
841 entries remain in the current plain-text shortening queue. Other review
