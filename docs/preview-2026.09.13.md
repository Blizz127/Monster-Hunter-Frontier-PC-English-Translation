...
two Mezeporta archives. The latest description pass adds 36 reviewed entries to the cumulative 172-entry description pass;
963 entries remain in the current plain-text shortening queue. Other review
