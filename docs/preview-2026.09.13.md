...
two Mezeporta archives. The latest description pass adds 30 reviewed entries to the cumulative 264-entry description pass;
871 entries remain in the current plain-text shortening queue. Other review
