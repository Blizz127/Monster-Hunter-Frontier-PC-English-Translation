...
two Mezeporta archives. The latest description pass adds 14 reviewed entries to the cumulative 965-entry description pass;
170 entries remain in the current plain-text shortening queue. Other review
