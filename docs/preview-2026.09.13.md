# Experimental translation update: 2026.09.13-preview.62
...
1135 source-reviewed description records. This preview also reflows 13283
word-preserving equipment-description records; the current census still has
10423 over-width records requiring review;
...
```console
python patch.py check client-english-2026.09.13-preview.62.zip --target "C:\Games\MHF\dat"
python patch.py apply client-english-2026.09.13-preview.62.zip --target "C:\Games\MHF\dat"
```
