...
two Mezeporta archives. The latest description pass adds 10 reviewed entries to the cumulative 1105-entry description pass;
30 entries remain in the current plain-text shortening queue. Other review
