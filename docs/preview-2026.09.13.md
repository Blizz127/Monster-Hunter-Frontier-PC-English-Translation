...
two Mezeporta archives. The latest description pass adds 20 reviewed entries to the cumulative 791-entry description pass;
344 entries remain in the current plain-text shortening queue. Other review
