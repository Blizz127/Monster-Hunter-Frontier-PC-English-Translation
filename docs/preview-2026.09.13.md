...
two Mezeporta archives. The latest description pass adds 20 reviewed entries to the cumulative 811-entry description pass;
324 entries remain in the current plain-text shortening queue. Other review
