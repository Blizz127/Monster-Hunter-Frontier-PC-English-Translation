...
two Mezeporta archives. The latest description pass adds 27 reviewed entries to the cumulative 321-entry description pass;
814 entries remain in the current plain-text shortening queue. Other review
