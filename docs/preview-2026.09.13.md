...
two Mezeporta archives. The latest description pass adds 20 reviewed entries to the cumulative 871-entry description pass;
264 entries remain in the current plain-text shortening queue. Other review
