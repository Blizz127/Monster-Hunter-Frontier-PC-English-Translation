...
two Mezeporta archives. The latest description pass adds 20 reviewed entries to the cumulative 931-entry description pass;
204 entries remain in the current plain-text shortening queue. Other review
