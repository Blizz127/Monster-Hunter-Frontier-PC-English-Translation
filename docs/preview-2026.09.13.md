...
two Mezeporta archives. The latest description pass adds 20 reviewed entries to the cumulative 891-entry description pass;
244 entries remain in the current plain-text shortening queue. Other review
