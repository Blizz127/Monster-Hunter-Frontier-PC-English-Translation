...
two Mezeporta archives. The latest description pass adds 30 reviewed entries to the cumulative 591-entry description pass;
544 entries remain in the current plain-text shortening queue. Other review
