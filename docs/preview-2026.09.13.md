# Experimental translation update: 2026.09.13-preview.69
...
1135 source-reviewed description records. This preview also reflows 206
source-reviewed equipment-description records; 5019 records still exceed the
...
```console
python patch.py check client-english-2026.09.13-preview.69.zip --target "C:\Games\MHF\dat"
python patch.py apply client-english-2026.09.13-preview.69.zip --target "C:\Games\MHF\dat"
```
