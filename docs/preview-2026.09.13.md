...
two Mezeporta archives. The latest description pass adds 30 reviewed entries to the cumulative 441-entry description pass;
694 entries remain in the current plain-text shortening queue. Other review
