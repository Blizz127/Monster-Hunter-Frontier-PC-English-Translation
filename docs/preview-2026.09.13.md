# Experimental translation update: 2026.09.13-preview.63
...
1135 source-reviewed description records. This preview also reflows 4917
word-preserving equipment-description records using visible text width; 5506
records still exceed the three-slot visible width and require source review;
...
```console
python patch.py check client-english-2026.09.13-preview.63.zip --target "C:\Games\MHF\dat"
python patch.py apply client-english-2026.09.13-preview.63.zip --target "C:\Games\MHF\dat"
```
