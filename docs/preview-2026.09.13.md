...
two Mezeporta archives. The latest description pass adds 30 reviewed entries to the cumulative 771-entry description pass;
364 entries remain in the current plain-text shortening queue. Other review
